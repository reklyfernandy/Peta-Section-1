...
map.getView().fit([11766357.237750, -734172.588187, 11767132.812743, -733745.974006], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA SECTION 1 KEBUN KELAPA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (66 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta batas Lahan, Batas blok, Titik tanam PT. Perkebunan Dewa Agri';
            }
